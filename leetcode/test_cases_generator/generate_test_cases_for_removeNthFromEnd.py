...
def read_parameters():
    with open("leetcode/config/test_cases/config_test_cases_for_removeNthFromEnd.yaml", 'r') as f:
...
def generate_test_cases():
    ...
    with open("test_cases/test_cases_for_removeNthFromEnd.json", 'w') as f:
